...
features = [col for col in data_BCI_SN.columns if col not in ['Date', 'Tendencia', 'Sentimiento Máximo', 'Sentimiento Mínimo', "Tendencia Sentimiento"]]
...
output_file_path = r'.\..\output\metricas_BCI\LR_segun_paper.txt'
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_BCI\LR_ajustado.txt'
with open(output_file_path, 'w') as f:
    f.write(f"Resultados para LR con Hiperparametros del paper:\n")
    f.write(f"Accuracy general del modelo: {overall_accuracy:.2f}\n")
    f.write(f"Precision global (ponderada): {overall_precision:.2f}\n")
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_BCI\DT_paper.txt'
with open(output_file_path, 'w') as f:
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_BCI\DT_mas_ajustado.txt'
with open(output_file_path, 'w') as f:
...
output_path = r'.\..\output\metricas_BCI\XGboost_con_100_submodels.txt'
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\XGboost_segun_paper.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\RF_segun_paper.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\RF_ajustado.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\NB_basico.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\MLP_basico.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_BCI\MLP_segun_paper.txt'
with open(output_path, 'w') as f:
...
output_path_lstm = r'.\..\output\metricas_BCI\LSTM__resultados.txt'
