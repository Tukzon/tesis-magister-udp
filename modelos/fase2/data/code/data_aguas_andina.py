...
#conteo_tendencia = data_aguas_SNN['Tendencia Sentimiento'].value_counts()
#conteo_tendencia

# Selección de todas las características excepto 'Date' y 'Tendencia'
features = [col for col in data_aguas_SNN.columns if col not in ['Date', 'Tendencia', 'Sentimiento Máximo', 'Sentimiento Mínimo', "Tendencia Sentimiento"]]
...
# Por ejemplo, si deseas revisar su correlación con la variable objetivo:
correlaciones = data_aguas_SNN.corr()['Tendencia'].sort_values(ascending=False)
print(correlaciones)
...
output_file_path = r'.\..\output\metricas_aguas\LR_aguas_segun_paper.txt'
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_aguas\LR_aguas_ajustado.txt'
with open(output_file_path, 'w') as f:
    f.write(f"Resultados para LR con Hiperparametros del paper:\n")
    f.write(f"Accuracy general del modelo: {overall_accuracy:.2f}\n")
    f.write(f"Precision global (ponderada): {overall_precision:.2f}\n")
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_aguas\DT_aguas.txt'
with open(output_file_path, 'w') as f:
...
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\metricas_aguas\DT_aguas_ajustado.txt'
with open(output_file_path, 'w') as f:
...
output_path = r'.\..\output\metricas_aguas\XGboost_aguas_con_100_submodels.txt'
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\XGboost_aguas_segun_paper.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\RF_aguas_segun_paper.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\RF_aguas_ajustado.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\NB_aguas.txt'
with open(output_path, 'w') as f:
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\MLP_aguas.txt'
with open(output_path, 'w') as f:
...
# MLP (Multi-Layer Perceptron) segun paper la clase 0 se muere
...
# Guardar resultados en archivo .text
output_path = r'.\..\output\metricas_aguas\MLP_aguas_segun_paper.txt'
with open(output_path, 'w') as f:
