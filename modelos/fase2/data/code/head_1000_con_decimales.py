...
def calculate_sentiment(analyzer, text):
    ...
    # Imprimir el resultado para entender su estructura
    print(f"Resultado del análisis para el texto: {text[:30]}...")  # Imprime los primeros 30 caracteres del texto
...
if __name__ == "__main__":
    ...
    df_noticias_sample = df_noticias.head(1000)
