# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 22:45:47 2024
...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\Input\CENCOSUD.SN.csv"
...
nueva_ruta_archivo = r'C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\CENCOSUD.SN.csv'
...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\CENCOSUD.SN.csv"

data_CENCOSUD_SN = pd.read_csv(ruta_archivo)

data_CENCOSUD_SN.head()
data_CENCOSUD_SN.columns
#Ahora a este archivo le haremos la estadistica descriptiva: 
    
# Estadísticas descriptivas por columnas
open_stats = data_CENCOSUD_SN['Open'].describe()
high_stats = data_CENCOSUD_SN['High'].describe()
low_stats = data_CENCOSUD_SN['Low'].describe()
close_stats = data_CENCOSUD_SN['Close'].describe()
adj_close_stats = data_CENCOSUD_SN['Adj Close'].describe()
volume_stats = data_CENCOSUD_SN['Volume'].describe()
tendencia_stats = data_CENCOSUD_SN['Tendencia'].describe()
macd_stats = data_CENCOSUD_SN['MACD_12_26_9'].describe()
macdh_stats = data_CENCOSUD_SN['MACDh_12_26_9'].describe()
macds_stats = data_CENCOSUD_SN['MACDs_12_26_9'].describe()
rsi_stats = data_CENCOSUD_SN['RSI'].describe()
...
num_cols = data_CENCOSUD_SN.select_dtypes(include=np.number).columns.tolist()

plt.figure(figsize=(15, 15))

for i, variable in enumerate(num_cols):
    plt.subplot(4, 3, i + 1)
    sns.boxplot(data=data_CENCOSUD_SN, x=variable)
