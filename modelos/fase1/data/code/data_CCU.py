...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\Input\CCU.SN.csv"
...
nueva_ruta_archivo = r'C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\CCU.SN.csv'
...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\CCU.SN.csv"
...
num_cols = data_CCU_SN.select_dtypes(include=np.number).columns.tolist()

plt.figure(figsize=(15, 15))

for i, variable in enumerate(num_cols):
    plt.subplot(4, 3, i + 1)
    sns.boxplot(data=data_CCU_SN, x=variable)
