...
ta_cols = [col for col in data_CCU_SN.columns if col not in static_cols + ['Date', 'Tendencia']]
...
output_file_path = r'.\..\output\LR_CCU_Hiperparametro_paper.txt'
...
#%%
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\LR_CCU_Ajuste.txt'
with open(output_file_path, 'w') as f:
...
output_path = r'.\..\output\DT_CCU_segun_paper.txt'
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\DT_CCU_con_ajuste.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\XGBoost_CCU_con_100_submodels.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\XGBoost_CCU_Segun_paper.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\RF_CCU_Segun_paper.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\RF_CCU_ajustado.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\NB_CCU_SelectKBest.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\NB_CCU_randomforest.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\MLP_CCU_basico_no_paper.text'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\MLP_CCU_según_paper.text'
with open(output_path, 'w') as f:
...
with open('./output/LSTM_CCU.txt', 'w') as f:
