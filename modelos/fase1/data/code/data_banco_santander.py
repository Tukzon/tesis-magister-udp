# -*- coding: utf-8 -*-
"""
Created on Fri Aug 23 22:37:52 2024
...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\Input\BSANTANDER.SN.csv"
...
nueva_ruta_archivo = r'C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\BSANTANDER.SN.csv'
...
ruta_archivo = r"C:\Users\benja\Desktop\Metodologia_tesis\tesis-magister-udp\modelos\fase1\data\output\BSANTANDER.SN.csv"

data_BSantander_SN = pd.read_csv(ruta_archivo)

data_BSantander_SN.head()
data_BSantander_SN.columns
#Ahora a este archivo le haremos la estadistica descriptiva: 
    
# Estadísticas descriptivas por columnas
open_stats = data_BSantander_SN['Open'].describe()
high_stats = data_BSantander_SN['High'].describe()
low_stats = data_BSantander_SN['Low'].describe()
close_stats = data_BSantander_SN['Close'].describe()
adj_close_stats = data_BSantander_SN['Adj Close'].describe()
volume_stats = data_BSantander_SN['Volume'].describe()
tendencia_stats = data_BSantander_SN['Tendencia'].describe()
macd_stats = data_BSantander_SN['MACD_12_26_9'].describe()
macdh_stats = data_BSantander_SN['MACDh_12_26_9'].describe()
macds_stats = data_BSantander_SN['MACDs_12_26_9'].describe()
rsi_stats = data_BSantander_SN['RSI'].describe()
