...
output_file_path = r'.\..\output\LR_CAP_Hiperparametro_paper.txt'
...
#%%
# Guardar los resultados en un archivo de texto
output_file_path = r'.\..\output\LR_CAP_Ajuste.txt'
with open(output_file_path, 'w') as f:
...
output_path = r'.\..\output\DT_CAP_segun_paper.txt'
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\DT_CAP_con_ajuste.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\XGBoost_CAP_con_100_submodels.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\XGBoost_CAP_Segun_paper.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\RF_CAP_Segun_paper.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\RF_CAP_ajustado.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\NB_CAP_SelectKBest.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\NB_CAP_randomforest.txt'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\MLP_CAP_basico_no_paper.text'
with open(output_path, 'w') as f:
...
#%%
# Guardar resultados en archivo .text
output_path = r'.\..\output\MLP_CAP_según_paper.text'
with open(output_path, 'w') as f:
...
with open('./output/LSTM_CAP.txt', 'w') as f:
